...
{
    public class ProcessorLoadHealthCheck : IHealthCheck
    {
        UInt16 maxCPUAllocationInPercentage, thresholdCPULoadPercentage = default;

        public ProcessorLoadHealthCheck(UInt16 maxCPUAllocationInPercentage,UInt16 thresholdCPULoadPercentage)
        {
            this.maxCPUAllocationInPercentage = maxCPUAllocationInPercentage;
            this.thresholdCPULoadPercentage = thresholdCPULoadPercentage;
        }
